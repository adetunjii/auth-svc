...
func (c *authServiceClient) InitEmailVerification(ctx context.Context, in *InitEmailVerificationRequest, opts ...grpc.CallOption) (*InitEmailVerificationResponse, error) {
	out := new(InitEmailVerificationResponse)
	err := c.cc.Invoke(ctx, "/auth.AuthService/InitEmailVerification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authServiceClient) InitPhoneVerification(ctx context.Context, in *InitPhoneVerificationRequest, opts ...grpc.CallOption) (*InitPhoneVerificationResponse, error) {
	out := new(InitPhoneVerificationResponse)
	err := c.cc.Invoke(ctx, "/auth.AuthService/InitPhoneVerification", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthServiceServer) InitEmailVerification(context.Context, *InitEmailVerificationRequest) (*InitEmailVerificationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitEmailVerification not implemented")
}
func (UnimplementedAuthServiceServer) InitPhoneVerification(context.Context, *InitPhoneVerificationRequest) (*InitPhoneVerificationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitPhoneVerification not implemented")
}
...
func _AuthService_InitEmailVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitEmailVerificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).InitEmailVerification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthService/InitEmailVerification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).InitEmailVerification(ctx, req.(*InitEmailVerificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _AuthService_InitPhoneVerification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitPhoneVerificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).InitPhoneVerification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.AuthService/InitPhoneVerification",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).InitPhoneVerification(ctx, req.(*InitPhoneVerificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _AuthService_GetAllCountries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(AuthServiceServer).GetAllCountries(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InitEmailVerification",
			Handler:    _AuthService_InitEmailVerification_Handler,
		},
		{
			MethodName: "InitPhoneVerification",
			Handler:    _AuthService_InitPhoneVerification_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _AuthService_GetAllCountries_Handler,
		},
	},
